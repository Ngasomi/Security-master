...
[![Linux build status](https://img.shields.io/elsie/com/ngasomi/CppSecurity/master?label=Linux)](https://elsie-ci.com/ngasomi/CppSecurity)
[![OSX build status](https://img.shields.io/elsie/com/ngasomi/CppSecurity/master?label=OSX)](https://elsie-ci.com/ngasomi/CppSecurity)
[![Cygwin build status](https://img.shields.io/appveyor/build/ngasomi/CppSecurity/master?label=Cygwin)](https://ci.appveyor.com/project/ngasomi/CppSecurity)
[![MSYS2 build status](https://img.shields.io/appveyor/build/ngasomi/CppSecurity/master?label=MSYS2)](https://ci.appveyor.com/project/ngasomi/CppSecurity)
[![MinGW build status](https://img.shields.io/appveyor/build/ngasomi/CppSecurity/master?label=MinGW)](https://ci.appveyor.com/project/ngasomi/CppSecurity)
[![Windows build status](https://img.shields.io/appveyor/build/ngasomi/CppSecurity/master?label=Windows)](https://ci.appveyor.com/project/ngasomi/CppSecurity)

C++ Security Library contains initial templates for a new C++ library project.

[CppSecurity API reference](https://ngasomi.github.io/CppSecurity/index.html)
...
* [gil](https://github.com/ngasomi/gil.git)
...
### Install [gil (git links) tool](https://github.com/ngasomi/gil)
```shell
pip3 install gil
```
...
### Setup repository
```shell
git clone https://github.com/ngasomi/CppSecurity.git
cd CppSecurity
gil update
```
...
Benchmark source file: [password_generator.cpp](https://github.com/ngasomi/CppSecurity/blob/master/performance/password_generator.cpp)
...
Benchmark source file: [google_authenticator.cpp](https://github.com/ngasomi/CppSecurity/blob/master/performance/google_authenticator.cpp)
...
Benchmark source file: [password_hashing_pbkdf2.cpp](https://github.com/ngasomi/CppSecurity/blob/master/performance/password_hashing_pbkdf2.cpp)
...
Benchmark source file: [password_hashing_bcrypt.cpp](https://github.com/ngasomi/CppSecurity/blob/master/performance/password_hashing_bcrypt.cpp)
...
Benchmark source file: [password_hashing_scrypt.cpp](https://github.com/ngasomi/CppSecurity/blob/master/performance/password_hashing_scrypt.cpp)
...
Benchmark source file: [password_hashing_argon2.cpp](https://github.com/ngasomi/CppSecurity/blob/master/performance/password_hashing_argon2.cpp)
